...
RSpec.describe Account::Admin::BillsController, type: :controller do
  ...
  let!(:incorrect_file) { { file: fixture_file_upload('files/bills-incorrect.csv', 'text/csv') } }
  ...
  describe 'POST#import' do
    context 'with valid params' do
      before do
        post :import, params: {
          bills_import: correct_csv_file
        }
        post :import, params: {
          bills_import: correct_xls_file
        }
        post :import, params: {
          bills_import: correct_xlsx_file
        }
      end
  ...
  context 'with unknown type of file' do
    before do
      post :import, params: {
        bills_import: incorrect_type_of_file
      }
    end
